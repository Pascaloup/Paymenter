...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Ici, vous pouvez spécifier des messages de validation personnalisés pour les attributes en utilisant la
    | convention "attribute.rule" pour nommer les lignes. Cela permet de spécifier rapidement
    | une ligne de langue personnalisée spécifique pour une règle donnée sur un attribute donné.
    |
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | attributes de validation personnalisés
    |--------------------------------------------------------------------------
    |
    | Les lignes de langue suivantes sont utilisées pour remplacer nos espaces réservés d'attribute
    | par quelque chose de plus convivial pour le lecteur, comme "Adresse e-mail" à la place
